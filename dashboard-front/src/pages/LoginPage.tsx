                ...
                <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" method={"post"} onSubmit={handleLogin}>
                            <div>
                                <div className="block mb-2 text-sm font-medium text-gray-900">Your
                                    email
                                </div>
                            ...
                            <p className="text-sm font-light text-gray-500">
                                Don’t have an account yet? <Link to="/register" className="font-medium text-sky-600 hover:underline">Sign up</Link>
                            </p>
                        </form>
                    </div>
                </div>
